...
{
	$HEADER_BACKGROUND_PATH=get_bloginfo('url')."/wp-content/themes/hackathon-theme/img/header-background-";
}
?><!DOCTYPE html>
...
<body <?php body_class(); ?>>
    ...
    <?php if( get_theme_mod( 'wpforge_nav_position' ) == 'fixed') { ?>
        <?php get_template_part( 'content', 'nav' ); ?>
    <?php } // end if ?>
		<div class="header_container" data-interchange="[<?php echo $HEADER_BACKGROUND_PATH?>small.jpg,(small)],
